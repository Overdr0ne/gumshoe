...
* Installation
  Gumshoe is available on [[https://melpa.org/#/gumshoe][MELPA]].  I just use straight+use-package like so:
...
** Backtracking
   ...
   - [[https://github.com/nex3/perspective-el][Perspective.el]] integration available via =persp-gumshoe= (see [[*Extensions]]).
...
* Extensions
  These are available as separate packages on MELPA. See their readmes for installation and usage details.
  - [[file:extensions/persp-gumshoe/readme.org][persp-gumshoe]] - [[https://github.com/nex3/perspective-el][perspective.el]] integration for perspective-aware backtracking and perusal
  - [[file:extensions/consult-gumshoe/readme.org][consult-gumshoe]] - [[https://github.com/minad/consult][consult]] integration with live preview as you browse the backlog
