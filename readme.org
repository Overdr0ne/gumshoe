...
** Backtracking
   ...
   - [[https://github.com/nex3/perspective-el][Perspective.el]] integration: Install [[https://github.com/Overdr0ne/persp-gumshoe][persp-gumshoe]] for perspective-aware backtracking with *gumshoe-persp-backtrack*.
...
** Consult Integration
   Install [[https://github.com/Overdr0ne/consult-gumshoe][consult-gumshoe]] for [[https://github.com/minad/consult][Consult]]-powered live previews while perusing the backlog. These commands have the same interface described above, just prefixed with =consult-=, e.g. =consult-gumshoe-peruse-in-buffer=.
** Manual Markers
...
* Change log
** 4.0
   - Extracted external dependencies into separate packages to avoid any conditional loading. For users:
  1. *Perspective users*: Install [[https://github.com/Overdr0ne/persp-gumshoe][persp-gumshoe]] and add ~(require 'persp-gumshoe)~
  2. *Consult users*: Install [[https://github.com/Overdr0ne/consult-gumshoe][consult-gumshoe]] and add ~(require 'consult-gumshoe)~

  All existing commands and functionality remain the same; they've just been moved to dedicated packages.
** 3.1
...
* Optional Integrations
  As of version 4.0, optional integrations have been moved to separate packages to avoid compilation errors when optional dependencies are not installed.

** perspective.el Integration
   Install [[https://github.com/Overdr0ne/persp-gumshoe][persp-gumshoe]] for perspective-aware backtracking:
   #+begin_src elisp
...
** consult Integration
   Install [[https://github.com/Overdr0ne/consult-gumshoe][consult-gumshoe]] for live preview while browsing:
   #+begin_src elisp
